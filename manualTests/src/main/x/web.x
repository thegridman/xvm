...
module TestWebApp
    ...
    class UsersApi
        ...
        void putUser(@PathParam String who, @Body User user)
            {
            // ToDo: There could probably be validation here which could show handling of exceptions etc.
            ...
            // just return multiple values, e.g. the respsonse body and a HttpStatus
            users.put(who, user);
            }
